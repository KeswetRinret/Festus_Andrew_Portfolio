  ...
  return (
    <div className='mx-32 mt-20 space-y-16'>
      ...
      <div className=''>
         ...
         <p className='font-secondaryFont text-lg mt-4'>Crafting engaging experiences from the initial click.
      ...
      <div className=''>
        ...
        <p className='font-secondaryFont text-lg mt-4'>Transforming visions into dynamic digital realities.
